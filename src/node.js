(function(process) {
  ...
  function requireNative(id) {
    ...
    var src = ((id[0] == '$' || id[2] == '$') ?
               global.__oni_rt.c1.compile(natives[id], { filename: id+'.js' }) :
               natives[id]);
    ...
    function loadModule(request, parent) {
      ...
      if (natives[id]) {
        ...
        if (id == 'repl') {
          ...
          // stratify it:
          var replSrc = global.__oni_rt.c1.compile(natives.repl,
                                                   {filename:'repl.js'});
...
*/
    ...
    Module.prototype._compile = function(content, filename, sjs) {
      ...
      if (contextLoad) {
        ...
        // the 'return' here is important for sequencing SJS:
