...
SlowBuffer.prototype.write = function(string, offset, encoding, soffset) {
  ...
  switch (encoding) {
    ...
    case 'binary':
      return this.binaryWrite(string, offset, soffset||0);
...
Buffer.prototype.write = function(string, offset, encoding, stroffset) {
  if (!isFinite(offset)) {
    var swap = encoding;
    encoding = offset;
    offset = swap;
  ...
  switch (encoding) {
    ...
    case 'binary':
    ret = this.parent.binaryWrite(string, this.offset + offset, maxLength, stroffset || 0);
      break;
